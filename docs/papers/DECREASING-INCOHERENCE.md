...
version: v0.1.0
date: 2026-05-22
proposed-path: docs/papers/DECREASING-INCOHERENCE.md
class: design essay
axis: gamma
related:
  - docs/THESIS.md
...
`docs/papers/COHERENCE-SYSTEM.md` names the system instruction set:
...
`docs/papers/FOUNDATIONS.md` gives the theory/practice stack:
...
`docs/papers/AGENT-FIRST.md` names the activation problem: probabilistic work needs durable continuity, explicit authority, and receipt-bearing evidence. It argues that a receipt is the legible handoff substrate for agent composition.

`docs/papers/CCNF-AND-TYPED-TRUST.md` establishes the typed-trust layer: CCNF defines the cell algorithm, CUE validates typed trust surfaces, `V` validates boundary readiness, and δ records a boundary decision.
