...
var negatives = map[string]struct {
	...
	"runinput-malformed-issue.json":    {OutcomeRejected, "cdsissue: problem.diverges is required"},
	"runinput-malformed-design.json":   {OutcomeRejected, "cdsdesign: approach is required"},
