<!-- wave-revision: R12 -->
# Wave-boundary pre-authorization evidence — oracle-ownership bijection (cnos#671 R12)
...
materialized wave-boundary validator, **content-bound to wave revision R12**.
