<!-- wave-revision: R13 -->
# Wave-boundary pre-authorization evidence — oracle-ownership bijection (cnos#671 R13)
...
materialized wave-boundary validator, **content-bound to wave revision R13**. (The validator and its
